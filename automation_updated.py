...
CODEFORCES_USER = "varadharajs2007"
LEETCODE_USER   = "Varun_S_24"
ATCODER_USER    = "VARADHARAJ"

CREDENTIALS_FILE = "valiant-splicer-489013-q2-05adb3236bf5.json"

# ===============================
# LOAD LEETCODE SESSION FROM config.json
# ===============================
...
if os.path.exists("config.json"):
    ...
    lc_user_cfg      = cfg.get("leetcode_user", "")
    if lc_user_cfg:
        LEETCODE_USER = lc_user_cfg
    print("config.json loaded ✅")
else:
    print("config.json not found ⚠️  — LeetCode fetch may fail. Create it using the setup tool.")
...
try:
    lc_sess.get("https://leetcode.com/", timeout=10)
